...
export interface CommandEffectMap {
    [CommandEffectType.TOAST]: Pick<Notification, 'message' | 'type' | 'duration' | 'actions'>;
 ...
 */
export type CommandEffect<EffectType extends CommandEffectType> = EffectType extends unknown
    ? { type: EffectType; payload: CommandEffectMap[EffectType] }
    : never;
